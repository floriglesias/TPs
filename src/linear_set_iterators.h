...
public:
     ...
     * \complexity{\O(1)}
     */
    const_iterator(const typename linear_set<T>::const_iterator &other);
     ...
     * \complexity{\O(1)}
     */
    const_iterator(const typename linear_set<T>::iterator &other);
...
private:
     ...
     */
    const_iterator(const typename linear_map<T, bool>::const_iterator &other);
...
template<typename T>
bool linear_set<T>::const_iterator::operator!=(const linear_set<T>::const_iterator &other) const {
    return not(it == other.it);
}

template<typename T>
linear_set<T>::const_iterator::const_iterator(
        const typename linear_map<T, bool>::const_iterator &other)
        : it(other) {}
...
template<typename T>
linear_set<T>::iterator::iterator(const typename linear_map<T, bool>::iterator &other) : it(other) {};
